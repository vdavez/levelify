...
test('Testing leveler with no level defined', function (t){
  ...
  t.deepEqual(["$1.0","$1.$1"], l.levels, 'testing for null levels');
  t.end();
})
...
test('Testing leveler with level defined', function (t){
  ...
  t.deepEqual(["$1.0.","$1.$1."], l.levels, 'testing levels for defined levels is set');
  ...
  t.deepEqual([ '$1', '$1' ], l.parseLevel(1), 'Testing parseLevel');
